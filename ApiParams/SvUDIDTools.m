...
static const char kKeychainUDIDItemIdentifier[]  = "UUID_customer";
static const char kKeyChainUDIDAccessGroup[] = "GxxB7xxPQS.com.boitx.customer";
...
+ (BOOL)settUDIDToKeyChain:(NSString*)udid
{
    ...
    [dictForAdd setValue:@"UUID_customer" forKey:(id)kSecAttrGeneric];
